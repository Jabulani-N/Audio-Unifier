...
def ask_two_options(box_title="Format selection",
    ...
    tk.Button(dialog, text=opt1, command=lambda: select_option(opt1)).pack(pady=5, side="left")
    tk.Button(dialog, text=opt2, command=lambda: select_option(opt2)).pack(pady=5, side="left")
    tk.Button(dialog, text=opt3, command=lambda: select_option(opt3)).pack(pady=5, side="right")
    tk.Button(dialog, text=opt4, command=lambda: select_option(opt4)).pack(pady=5, side="right")
