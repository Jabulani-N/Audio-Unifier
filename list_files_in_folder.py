...
if you want to list all files of multiple extensions, change the script that summons this one
to make it summon this script once for each file type,
and append the output list
